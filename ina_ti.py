...
def _build_operating_mode(continuous: bool = True, shunt_voltage: bool = True,
                          bus_voltage: bool = True) -> int:
...
class INA219(INA219Simple, IBaseSensorEx, Iterator):
    ...
    def __init__(self, adapter: bus_service.BusAdapter, address=0x40, shunt_resistance: float = 0.1):
        ...
        self._shunt_voltage_enabled
        self._bus_voltage_enabled
    ...
    def get_bus_voltage_range(self) -> tuple:
        ...
        return (INA219._vbus_max, 0) if self.bus_voltage_range else 16, 0
    ...
    def set_config(self) -> int:
        ...
        #
        raw_config = _build_operating_mode()
